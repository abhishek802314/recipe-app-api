...
class PrivateIngredientApiTests(TestCase):
    ...
    def test_retrieve_ingredients(self):
        ...
        res = self.client.get(INGRIDIENTS_URL)
        ingedients = Ingredient.objects.all().order_by('-name')
        serializer = IngredientSerializer(ingedients, many=True)
    ...
    def test_filtered_ingredients_unique(self):
        ...
        ing = Ingredient.objects.create(user=self.user, name='tags')
